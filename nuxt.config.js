...
module.exports = {
  ...
  */
  head: {
    ...
    meta: [
      { charset: 'utf-8' },
      { name: 'description', content: 'TLVD, aka Tel Aviv Digital is a creative communications agency, which specializes in developing branded advertising and interactive experiences.' },
      { name: 'apple-mobile-web-app-title', content: 'TLVD' },
      { name: 'application-name', content: 'Tel Aviv Digital' },
      { property: 'og:title', content: 'Tel Aviv Digital'},
